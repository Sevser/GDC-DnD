...
"description_rus": "Описание на русском", // текст находящийся внутри, экранируй с помощью https://tools.icoder.uz/json-escape-unescape.php иначе пойдет по пизде.

"descriptionNextLevel_rus": "Описание на русском", // текст находящийся внутри, экранируй с помощью https://tools.icoder.uz/json-escape-unescape.php иначе пойдет по пизде.
